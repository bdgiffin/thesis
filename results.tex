...
The $J_2$ model of hypo-elasto-plasticity with linear isotropic hardening was implemented, employing the radial return algorithm described in \cite{LSDYNA}. This model is utilized in the two problems considered herein, entailing the specification of the following material parameters: Young's modulus $E$, Poisson's ratio $\nu$, the initial yield stress $Y_0$, and the linear hardening modulus $E_h$.
