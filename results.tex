...
$\alpha_{\gamma1} = 0.0$	&	$5.44 \times 10^{2}$ & $4.07 \times 10^0$ & $5.94 \times 10^{3}$ & $5.96 \times 10^{6}$ \\ \hline
$\alpha_{\gamma1} = 10^{0}$	&	$4.96 \times 10^{3}$ & $2.01 \times 10^{1}$ & $9.33 \times 10^{2}$ & $9.29 \times 10^{5}$ \\ \hline
$\alpha_{\gamma1} = 10^{3}$	&	$1.58 \times 10^{7}$ & $2.50 \times 10^{4}$ & $6.96 \times 10^{1}$ & $1.11 \times 10^{3}$ \\ \hline
$\alpha_{\gamma1} = 10^{6}$	&	$2.37 \times 10^{10}$ & $2.50 \times 10^{7}$ & $6.86 \times 10^{4}$ & $6.98 \times 10^{1}$ \\
    \hline
    \end{tabular}
...
\begin{tabular}{| c || c | c | c | c |}
    \hline
$\kappa(\bm{J})$ & $\alpha_{\gamma0} = 10^{-3}$	&	$\alpha_{\gamma0} = 10^{0}$	&	$\alpha_{\gamma0} = 10^{3}$	&	$\alpha_{\gamma0} = 10^{6}$ \\ \hline \hline
$\alpha_{\gamma1} = 0.0$	& $9.07 \times 10^{3}$ & $1.39 \times 10^{2}$ & $1.14 \times 10^{5}$ & $1.33 \times 10^{8}$ \\ \hline
...
\begin{table}[!ht]
  \begin{center}
    \begin{tabular}{| l || c | c |}
    \hline
           & $||\bm{u}^h - \bm{u}|| / ||\bm{u}||$ & $||\boldsymbol{\sigma}^h - \boldsymbol{\sigma}|| / ||\boldsymbol{\sigma}||$ \\ \hline \hline
    FEM (4-node quadrilaterals) & $5.1568 \times 10^{-15}$ & $7.7395 \times 10^{-16}$ \\ \hline
    CG-PEM (no gradient correction) & $5.9125 \times 10^{-12}$ & $5.1637 \times 10^{-12}$ \\ \hline
    DG-PEM (no gradient correction) & $2.7721 \times 10^{-5}$ & $3.0904 \times 10^{-4}$ \\ \hline
    DG-PEM (symmetric correction) & $6.2750 \times 10^{-12}$ & $5.3521 \times 10^{-12}$ \\ \hline
    DG-PEM (nonsymmetric correction) & $6.2673 \times 10^{-12}$ & $5.3494 \times 10^{-12}$ \\
    \hline
    \end{tabular}
...
\begin{table}[!ht]
  \begin{center}
    ...
    DG-PEM & $\alpha_{\gamma0} = 10^{-6}$ & $\alpha_{\gamma0} = 10^{-3}$ & $\alpha_{\gamma0} = 10^{0}$ & $\alpha_{\gamma0} = 10^{3}$ & $\alpha_{\gamma0} = 10^{6}$ \\ \hline \hline
    	$\alpha_{\gamma1} = 0.0$ & $2.8433 \times 10^{-9}$ & $2.8152 \times 10^{-6}$ & $3.3114 \times 10^{-4}$ & $4.8035 \times 10^{-6}$ & $4.8278 \times 10^{-9}$ \\ \hline
    $\alpha_{\gamma1} = 10^{-3}$ & $2.8505 \times 10^{-9}$ & $2.8224 \times 10^{-6}$ & $3.2288 \times 10^{-4}$ & $4.9805 \times 10^{-6}$ & $5.0082 \times 10^{-9}$ \\ \hline
    $\alpha_{\gamma1} = 10^{0}$ & $3.4853 \times 10^{-9}$ & $3.4604 \times 10^{-6}$ & $2.4827 \times 10^{-3}$ & $7.4284 \times 10^{-4}$ & $8.6376 \times 10^{-7}$ \\ \hline
    $\alpha_{\gamma1} = 10^{3}$ & $3.5460 \times 10^{-9}$ & $3.5450 \times 10^{-6}$ & $3.0047 \times 10^{-3}$ & $1.3898 \times 10^{-2}$ & $7.4705 \times 10^{-4}$ \\ \hline
    $\alpha_{\gamma1} = 10^{6}$ & $3.5457 \times 10^{-9}$ & $3.5456 \times 10^{-6}$ & $3.0054 \times 10^{-3}$ & $1.4604 \times 10^{-2}$ & $1.3953 \times 10^{-2}$ \\
    \hline
    \end{tabular}
...
\begin{table}[!ht]
  \begin{center}
    ...
    \hline
    DG-PEM & $\kappa(\bm{J})$ &  $E_1 (\Omega)$ & $||\bm{u}^h - \bm{u}|| / ||\bm{u}||$ & $||\boldsymbol{\sigma}^h - \boldsymbol{\sigma}|| / ||\boldsymbol{\sigma}||$ \\ \hline \hline
    $\alpha_{\gamma0} = 10^{0}$ & $4.3653 \times 10^0$ & $3.7339 \times 10^{-15}$ & $3.9872 \times 10^{-5}$ & $3.3113 \times 10^{-4}$ \\ \hline
    $\alpha_{\gamma0} = 10^{3}$ & $6.1670 \times 10^{3}$ & $2.5645 \times 10^{-12}$ & $3.5373 \times 10^{-7}$ & $4.8035 \times 10^{-6}$ \\ \hline
    $\alpha_{\gamma0} = 10^{6}$ & $6.1816 \times 10^{6}$ & $2.2129 \times 10^{-9}$ & $3.5767 \times 10^{-10}$ & $4.8276 \times 10^{-9}$ \\ \hline
    $\alpha_{\gamma0} = 10^{9}$ & $6.1817 \times 10^{9}$ & $1.6471 \times 10^{-6}$ & $1.4331 \times 10^{-9}$ & $2.4472 \times 10^{-8}$ \\ \hline
    $\alpha_{\gamma0} = 10^{12}$ & $6.1821 \times 10^{12}$ & $1.7678 \times 10^{-3}$ & $2.1612 \times 10^{-6}$ & $3.0495 \times 10^{-5}$ \\
    \hline
    \end{tabular}
...
\begin{table}[!ht]
  \begin{center}
    ...
    \hline
           & $E_1 (\Omega)$ & $||\bm{u}^h - \bm{u}|| / ||\bm{u}||$ & $||\boldsymbol{\sigma}^h - \boldsymbol{\sigma}|| / ||\boldsymbol{\sigma}||$ \\ \hline \hline
    FEM (regular hexahedra) & $2.4441 \times 10^{-16}$ & $1.5371 \times 10^{-15}$ & $8.1102 \times 10^{-16}$ \\ \hline
    FEM (distorted hexahedra) & $3.4394 \times 10^{-16}$ & $7.5402 \times 10^{-11}$ & $1.6047 \times 10^{-10}$ \\ \hline
    DG-PEM (no gradient correction) & $2.0369 \times 10^{-8}$ & $2.7189 \times 10^{-1}$ & $4.4846 \times 10^{-1}$ \\ \hline
    DG-PEM (symmetric correction) & $4.1522 \times 10^{-8}$ & $1.2598 \times 10^{-8}$ & $4.1608 \times 10^{-8}$ \\ \hline
    DG-PEM (nonsymmetric correction) & $2.0369 \times 10^{-8}$ & $1.0193 \times 10^{-8}$ & $2.9253 \times 10^{-8}$ \\
    \hline
    \end{tabular}
...
\begin{table}[!ht]
  \begin{center}
    \begin{tabular}{| l || c | c | c |}
    \hline
           & $E_2 (\Omega)$ & $||\bm{u}^h - \bm{u}|| / ||\bm{u}||$ & $||\boldsymbol{\sigma}^h - \boldsymbol{\sigma}|| / ||\boldsymbol{\sigma}||$ \\ \hline \hline
    FEM (regular 8-node quadrilaterals) & $9.0812 \times 10^{-16}$ & $1.7437 \times 10^{-9}$ & $1.3950 \times 10^{-8}$ \\ \hline
    FEM (distorted 8-node quadrilaterals) & $4.7831 \times 10^{-3}$ & $9.9714 \times 10^{-5}$ & $2.0795 \times 10^{-3}$ \\ \hline
    FEM (regular 9-node quadrilaterals) & $8.6713 \times 10^{-16}$ & $1.7437 \times 10^{-9}$ & $1.3950 \times 10^{-8}$ \\ \hline
    FEM (distorted 9-node quadrilaterals) & $1.2818 \times 10^{-15}$ & $2.0841 \times 10^{-9}$ & $1.5752 \times 10^{-8}$ \\ \hline
    DG-PEM (no gradient correction) & $3.3857 \times 10^{-8}$ & $9.8535 \times 10^{-2}$ & $2.8876 \times 10^{-1}$ \\ \hline
    DG-PEM (symmetric correction) & $3.6486 \times 10^{-7}$ & $3.5935 \times 10^{-8}$ & $1.4642 \times 10^{-7}$ \\ \hline
    DG-PEM (nonsymmetric correction) & $3.3857 \times 10^{-8}$ & $4.5498 \times 10^{-9}$ & $5.5341 \times 10^{-9}$ \\
    \hline
    \end{tabular}
...
\begin{table}[!ht]
  \begin{center}
    ...
    \hline
           & $E_2 (\Omega)$ & $||\bm{u}^h - \bm{u}|| / ||\bm{u}||$ & $||\boldsymbol{\sigma}^h - \boldsymbol{\sigma}|| / ||\boldsymbol{\sigma}||$ \\ \hline \hline
    FEM (regular hexahedra) & $6.1677 \times 10^{-16}$ & $6.9751 \times 10^{-9}$ & $2.7900 \times 10^{-8}$ \\ \hline
    FEM (distorted hexahedra) & $5.6085 \times 10^{-3}$ & $1.4755 \times 10^{-4}$ & $1.4958 \times 10^{-3}$ \\ \hline
    DG-PEM (no gradient correction) & $3.2351 \times 10^{-8}$ & $1.3054 \times 10^{-1}$ & $2.9833 \times 10^{-1}$ \\ \hline
    DG-PEM (symmetric correction) & $9.7520 \times 10^{-2}$ & $2.4536 \times 10^{-2}$ & $3.1112 \times 10^{-2}$ \\ \hline
    DG-PEM (nonsymmetric correction) & $3.2351 \times 10^{-8}$ & $2.6577 \times 10^{-8}$ & $1.1622 \times 10^{-8}$ \\
    \hline
    \end{tabular}
