...
\subsection*{Element Stiffness Matrix Conditioning}

\subsubsection*{Concave Elements}

\begin{figure}[!h]
  \centering
  \includegraphics[width=5.0in]{figures/concave_element_comparison.pdf}  \caption{Comparison of shape functions computed for a set of polygonal elements using VETFEM, CG-PEM, and DG-PEM.}
...
\caption{Comparison of maximum and minimum (non-zero) eigenvalues of the element stiffness matrix for the elements shown in Figure \ref{fig:concave_element_comparison}.}
\label{tab:concave_stiffness_max_min_eigenvalue}
\end{table}

\subsubsection*{Elements with Degenerate Edges}

\begin{figure}[!h]
  \centering
  \includegraphics[width=5.0in]{figures/degenerate_element_comparison.pdf}  \caption{Comparison of shape functions computed for a set of polygonal elements using VETFEM, CG-PEM, and DG-PEM.}
...
\caption{Comparison of maximum and minimum (non-zero) eigenvalues of the element stiffness matrix computed for the elements shown in Figure \ref{fig:degenerate_element_comparison}.}
