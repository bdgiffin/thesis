...
\end{equation}
and $R_\varepsilon \geq 1$ without loss of generality. Under these conditions, it suffices to assert that $\exists \, C > 0$ which may be used to establish uniform upper and lower bounds on $J^{\varepsilon}_{aa}$, such that
\begin{equation}
